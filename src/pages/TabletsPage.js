...
const TabletsBox = ({ title, products }) => {
  return (
...
const TabletsPage = () => {
  ...
  return (
    <div className="SmartphonesPage">
      <TabletsBox title="Apple" products={appleProducts} />
      <TabletsBox title="삼성" products={samsungProducts} />
      <TabletsBox title="Pixel" products={pixelProducts} />
